...
async function parseShardedIndex(path, params) {
  ...
  let index;
  try {
    index = JSON.parse(await indexBlob.slice(0, 1e7).text());
  } catch (error) {
